  ...
  <div class="privacyPolicyPage">
    <v-sheet class="mt-8 pa-4">
      ...
      <p>
        ...
        references to The Quantum Materials Optoelectronics Laboratory at UCR
        include qmolab.ucr.edu and QMO Lab. The QMO Lab website is a UCR
        Department of Physics and Astronomy Physics Research Group site. By
      ...
      <p>
        ...
        an account on our Site; (b) sending us an email message; (c) sending us
        a message through a contact form. To wit, we will use your information
      ...
      <p>
        ...
        process served on QMO Lab or the site; (b) protect and defend the rights
      ...
      <p>
        ...
        personalize QMO Lab pages, or register with QMO Lab site or services, a
        cookie helps QMO Lab to recall your specific information on subsequent
        ...
        When you return to the same QMO Lab website, the information you
